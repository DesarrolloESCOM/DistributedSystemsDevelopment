...
class CalculatorServer extends UnicastRemoteObject implements RMI_Operations {
    ...
    static void main(String[] args){
        ...
        RMI_Operations operationsStub = (RMI_Operations)UnicastRemoteObject.exportObject(server,7777)
        // Binding
        //Registry registry = LocateRegistry.getRegistry()
        Naming.rebind("RMI_Operations",operationsStub)
        println("Server's ready")
    }
}
